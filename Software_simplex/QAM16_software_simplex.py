...
class QAM16_software_simplex(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(1, 2):
            self.controls_grid_layout_0.setColumnStretch(c, 1)
        self._timing_loop_bw_0_range = Range(0.0, 0.1, 0.001, 6.28/200, 200)
        self._timing_loop_bw_0_win = RangeWidget(self._timing_loop_bw_0_range, self.set_timing_loop_bw_0, 'timing_loop_bw', "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        for c in range(0, 1):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self._x_range = Range(0, 1, 0.001, 0.9471, 200)
        ...
        self.digital_lms_dd_equalizer_cc_2 = digital.lms_dd_equalizer_cc(15, eq_gain, 2, pld_const_16qam)
        ...
        self.connect((self.digital_lms_dd_equalizer_cc_2, 0), (self.digital_constellation_receiver_cb_0, 0))
    ...
    def set_taps_1(self, taps_1):
        self.taps_1 = taps_1
        self.channels_channel_model_0.set_taps(self.taps_1)
