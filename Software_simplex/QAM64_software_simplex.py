...
class QAM64_software_simplex(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QAM64_software_simplex", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QAM64_software_simplex")
        ...
        self.settings = Qt.QSettings("GNU Radio", "QAM64_software_simplex")
        ...
        for c in range(1, 2):
            self.controls_grid_layout_0.setColumnStretch(c, 1)
        self._delay_range = Range(0, 200, 1, 174, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._gain_tx_range = Range(0, 74, 1, 45, 200)
        ...
        for c in range(0, 1):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self._eq_gain_range = Range(0.0, 0.001, 0.0001, 0.001, 200)
        ...
        for c in range(0, 1):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self._x_range = Range(0, 1, 0.001, 0.9393, 200)
        ...
        self.digital_constellation_receiver_cb_0 = digital.constellation_receiver_cb(digital.qam_constellation(64,True,digital.mod_codes.GRAY_CODE,False).base(), phase_bw, -0.5, 0.5)
        self.digital_constellation_decoder_cb_0 = digital.constellation_decoder_cb(digital.qam_constellation(64,True,digital.mod_codes.GRAY_CODE,True).base())
        self.digital_cma_equalizer_cc_0_0_0 = digital.cma_equalizer_cc(15, 1.4, 1e-6, 2)
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_char*1, 174)
        ...
        self.connect((self.digital_cma_equalizer_cc_0_0_0, 0), (self.digital_constellation_receiver_cb_0, 0))
...
def main(top_block_cls=QAM64_software_simplex, options=None):
