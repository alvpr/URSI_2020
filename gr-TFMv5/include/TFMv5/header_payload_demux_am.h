...
#ifndef INCLUDED_TFMV5_HEADER_PAYLOAD_DEMUX_AM_H
#define INCLUDED_TFMV5_HEADER_PAYLOAD_DEMUX_AM_H
 ...
 *
 */
class TFMV5_API header_payload_demux_am : virtual public block
{
public:
    typedef std::shared_ptr<header_payload_demux_am> sptr;
...
#endif /* INCLUDED_TFMv5_HEADER_PAYLOAD_DEMUX_AM_H */
