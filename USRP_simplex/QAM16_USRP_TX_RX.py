...
class QAM16_USRP_TX_RX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QAM16_USRP_TX_RX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QAM16_USRP_TX_RX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "QAM16_USRP_TX_RX")
        ...
        self.taps_0 = taps_0 = [0.95,0,0,0,0.312]
        ...
        self.digital_lms_dd_equalizer_cc_2_0_0_0 = digital.lms_dd_equalizer_cc(15, 100e-9, 2, pld_const_16qam)
        self.digital_diff_encoder_bb_0 = digital.diff_encoder_bb(16)
        self.digital_diff_decoder_bb_0_0 = digital.diff_decoder_bb(16)
        self.digital_constellation_receiver_cb_0 = digital.constellation_receiver_cb(pld_const_16qam, phase_bw, -0.5, 0.5)
        self.digital_constellation_decoder_cb_0 = digital.constellation_decoder_cb(digital.qam_constellation(16,True,digital.mod_codes.GRAY_CODE,False).base())
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc(pld_const_16qam.points(), 1)
        ...
        self.TFMv5_dispersion_probe_0_1 = TFMv5.dispersion_probe(2, samp_rate/2, 0, 0.001, 0.003, 0.006, 0.01)
        self.TFMv1_energy_scale_0 = TFMv1.energy_scale(1, 3e6, 3)
        ...
        # Connections
        ##################################################
        self.connect((self.TFMv1_energy_scale_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
        ...
        self.connect((self.digital_constellation_receiver_cb_0, 4), (self.TFMv5_dispersion_probe_0_1, 0))
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.digital_lms_dd_equalizer_cc_2_0_0_0, 0))
...
def main(top_block_cls=QAM16_USRP_TX_RX, options=None):
