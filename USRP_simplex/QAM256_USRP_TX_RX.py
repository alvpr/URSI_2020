...
class QAM256_USRP_TX_RX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QAM256_USRP_TX_RX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QAM256_USRP_TX_RX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "QAM256_USRP_TX_RX")
        ...
        self.digital_lms_dd_equalizer_cc_0 = digital.lms_dd_equalizer_cc(15, eq_gain, 2, digital.qam_constellation(256, True,digital.mod_codes.GRAY_CODE,True).base())
        self.digital_diff_encoder_bb_0 = digital.diff_encoder_bb(256)
        self.digital_diff_decoder_bb_0_0 = digital.diff_decoder_bb(256)
        self.digital_constellation_receiver_cb_0 = digital.constellation_receiver_cb(digital.qam_constellation(256,True,digital.mod_codes.GRAY_CODE,True).base(), phase_bw, -0.5, 0.5)
        self.digital_constellation_decoder_cb_0 = digital.constellation_decoder_cb(digital.qam_constellation(256,True,digital.mod_codes.GRAY_CODE,False).base())
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc(digital.qam_constellation(256,True,digital.mod_codes.GRAY_CODE,True).points(), 1)
...
def main(top_block_cls=QAM256_USRP_TX_RX, options=None):
