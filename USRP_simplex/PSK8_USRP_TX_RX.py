...
class PSK8_USRP_TX_RX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PSK8_USRP_TX_RX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PSK8_USRP_TX_RX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PSK8_USRP_TX_RX")
        ...
        self.digital_constellation_decoder_cb_0 = digital.constellation_decoder_cb(digital.constellation_8psk().base())
        self.digital_cma_equalizer_cc_0 = digital.cma_equalizer_cc(15, 1, 0.0002, 2)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc(digital.constellation_8psk().points(), 1)
...
def main(top_block_cls=PSK8_USRP_TX_RX, options=None):
