...
class BPSK_USRP_TX_RX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BPSK_USRP_TX_RX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK_USRP_TX_RX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "BPSK_USRP_TX_RX")
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._eq_gain_range = Range(0.0, 0.001, 0.0001, 0.000001, 200)
        ...
        self.digital_cma_equalizer_cc_0_0 = digital.cma_equalizer_cc(15, 1, 1e-6, 2)
        ...
        self.connect((self.TFMv1_energy_scale_0, 0), (self.qtgui_sink_x_1_0, 0))
        ...
        self.connect((self.digital_cma_equalizer_cc_0_0, 0), (self.digital_costas_loop_cc_0, 0))
        ...
        self.connect((self.digital_symbol_sync_xx_0, 0), (self.digital_cma_equalizer_cc_0_0, 0))
...
def main(top_block_cls=BPSK_USRP_TX_RX, options=None):
